...
<div class="pwrapper">
  <div id="panel2">
    <a href="" id="resume-link"><span id="res-txt">Resume</span><i class="fa-solid fa-arrow-up-right-from-square"></i> </a>
</div>
<div id="panel1">
<h2 id="heading">Interpersonal Skills</h2>
<div id="softskills-wrapper"> 
  ...
  <p>
     ...
     Tempore incidunt error placeat pariatur maiores. 
     Accusamus, optio! Numquam incidunt<span id="point">.</span>
  </p>
  </div>
  <div class="p1-item">
...
#heading{
    background: -webkit-linear-gradient(280deg, rgba(255,255,255,1) 0%, rgba(250,250,250,0) 100%);
